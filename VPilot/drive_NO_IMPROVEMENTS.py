...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--save_dir', default='Z:\\DeepGTAV-EXPORTDIR-TEST\\Generation6_TESTING_IF_OLD_VERSION_DOES_NOT_CRASH', help='The directory the generated data is saved to')
